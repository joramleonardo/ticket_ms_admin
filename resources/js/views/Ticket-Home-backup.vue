            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12"
                        ...
                        <h1>Ticket Management <em>SYSTEM</em></h1>
                        ...
                        <a href="#about" class="main-button-slider">Submit a Request</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        <div class="features-icon">
                            ...
                            <!-- <img :src="require('@/public/images/features-icon-1.png')" alt=""> -->
                            <!-- <img :src="{ $asset('images/features-icon-1.png')}" alt=""> -->
                            <!-- <img :src="asset('images/features-icon-1.png')" alt=""> -->
                            <!-- <img src="/images/features-icon-1.png" alt=""> -->
                            <h4>Follow up a Ticket</h4>
                            <p>Please provide your ticket reference code.</p>
                            <!-- <a href="/followup" class="main-button">
                                Click here
                            </a> -->
                            <router-link to="/followup" class="main-button" >
                                Click here
                            </router-link>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        <div class="features-icon">
                            <!-- <h2>02</h2> -->
                            <!-- <img src="assets/images/features-icon-2.png" alt="test"> -->
                            <h4>Submit a Feedback</h4>
                            <p>Curabitur pulvinar vel odio sed sagittis. Nam maximus ex diam, nec consectetur diam.</p>
                            <router-link to="/feedback" class="main-button" >
                                Click here
                            </router-link>
                        </div>
                    </div>
